...
////////////////////////////////////////////////////////////////////////////////////
// Détail d'un parenaire => préremplir l'input hidden "agence"
////////////////////////////////////////////////////////////////////////////////////
$(document).ready(function() {
	if($(".partnerpost__form").length == 1) {
		var agencyName = $(".partnerpost__title").text();
		var trimedAgencyName = $.trim(agencyName);

		$(".agency-hidden").val(trimedAgencyName);
	}
});
...
////////////////////////////////////////////////////////////////////////////////////
// Open price popup by timer
////////////////////////////////////////////////////////////////////////////////////
$(window).load(function() {
	var timer = setTimeout(showpricepopup, 15000);
});

function showpricepopup() {
	stp_show_popup("popup_price_mail");
}
