...
function theme_scripts_and_css() {
	wp_enqueue_script('scriptfile', get_stylesheet_directory_uri() . '/assets/js/js-dist.js', array('jquery'), time());
	// wp_enqueue_script('jqueryuifile', get_stylesheet_directory_uri() . '/node_modules/jquery-ui/js-dist.js', array('jquery'));
	wp_enqueue_style('stylefile', get_stylesheet_directory_uri() . '/assets/css/style.css', array(), time());
}
